...
{
    class WizardBulletRed : GameObject
    {
        int i = 0;
        ...
        public WizardBulletRed(Texture2D texture) : base(texture)
        {
                ...
                case WizardBulletState.FIREBALLFIRED:
                    {
                        ...
                        foreach (GameObject s in gameObjects)
                        {
                            if (IsTouching(s) && (s.Name.Equals("BlueArcher") || s.Name.Equals("BlueAxeman") || s.Name.Equals("BlueSpearman") || s.Name.Equals("BlueWizard")))
                            {
                                s.Hp -= rnd.Next(9) + 15;
                                wizardbulletStates = WizardBulletState.DIE;
                            }
                            if (IsTouching(s) && s.Name.Equals("BlueFlag"))
                            {
                                s.Hp -= rnd.Next(4) + 8;
                                wizardbulletStates = WizardBulletState.DIE;
                            }
